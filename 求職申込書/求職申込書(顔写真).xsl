  ...
  <xsl:template match="Process">
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
      <fo:layout-master-set>
        <fo:simple-page-master margin-right="10mm" margin-left="10mm" margin-bottom="2mm" margin-top="2mm" page-height="297mm" page-width="210mm" master-name="A4">
      ...
      <xsl:for-each select="Item">	
        ...
        <fo:page-sequence master-reference="A4" font-family="IPA Gothic,IPAGothic" font-size="9">
          ...
          <fo:static-content flow-name="xsl-region-before">
			...
			<fo:block text-align="right" display-align="after" font-size="8pt" padding-top="1mm">
			面接日時:
          ...
          <fo:flow flow-name="xsl-region-body">
            <fo:table table-layout="fixed" width="100%" margin-top="20mm" border="0.8pt solid">
				...
				<fo:table-column column-number="5" column-width="38mm"/>
				<fo:table-body>
					<fo:table-row>
						...
						<!-- ===========顔写真=========== -->
						<fo:table-cell number-rows-spanned="4" display-align="center">
							<fo:block>
								<xsl:choose>
									<xsl:when test="Process.P_Resume/Resume/Resume.U_E08D3C86CE78CA27612053EA772453 != '' and Process.P_Resume/Resume/Resume.U_E08D3C86CE78CA27612053EA772453 != '顔写真'">
										<fo:external-graphic src="{Process.P_Resume/Resume/Resume.U_E08D3C86CE78CA27612053EA772453}"
										content-width="38mm" content-height="50mm" scaling="uniform"/>
									</xsl:when>
									<xsl:otherwise>
										<fo:block text-align="center">写真なし</fo:block>
									</xsl:otherwise>
								</xsl:choose>
							</fo:block>
						</fo:table-cell>
					...
					<fo:table-row line-height="12mm">
						<fo:table-cell border="0.8pt solid" display-align="center">
							<fo:block text-align="center">生年月日</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.8pt solid" display-align="center">
							<fo:block text-align="center">
						...
						<fo:table-cell border="0.8pt solid" display-align="center">
							<fo:block text-align="center" line-height="1.0" padding="0mm" margin="0mm">求　職</fo:block>
							<fo:block text-align="center" line-height="1.0" padding="0mm" margin="0mm">有効期間</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.8pt solid" display-align="center">
							<fo:block text-align="center">
			...
			<fo:table table-layout="fixed" border="0.8pt solid">
				...
				<fo:table-body>
					<fo:table-row line-height="10mm">
						<fo:table-cell border="0.8pt solid" display-align="center">	
							<fo:block padding="1mm" text-align="center">電話番号</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.8pt solid" display-align="center">						
					...
					<fo:table-row line-height="10mm">
						<fo:table-cell border="0.8pt solid">
							<fo:block padding="1mm" text-align="center">最終学歴</fo:block>
						</fo:table-cell>
			...
			<fo:table table-layout="fixed">
				<fo:table-column column-number="1" column-width="20mm"/>
				<fo:table-column column-number="2" column-width="170mm"/>
			...
			<fo:table table-layout="fixed" border="0.8pt solid">
				...
				<fo:table-column column-number="3" column-width="56.6mm"/>
				<fo:table-column column-number="4" column-width="56.7mm"/>
				<fo:table-column column-number="5" column-width="56.7mm"/>
				...
				<fo:table-body>
					...
					<fo:table-row line-height="7mm" border="0.8pt solid">
						...
						<fo:table-cell border="0.8pt solid" display-align="center">
							<fo:block text-align="center">勤務地</fo:block>
						</fo:table-cell>
						<fo:table-cell border="0.8pt solid" display-align="center">
							<fo:block>
					...
					<fo:table-row>
						<fo:table-cell border="0.8pt solid" display-align="center">
							<fo:block text-align="center" line-height="10pt">勤　務</fo:block>
							<fo:block text-align="center" line-height="10pt">時　間</fo:block>
						</fo:table-cell>
						<fo:table-cell number-columns-spanned="4" border-bottom="0.8pt solid" padding-left="2mm" display-align="center">
							<fo:block>
								<fo:inline padding="1mm">
